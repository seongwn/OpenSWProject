...
int main() {
	...
	//clock_t start = clock();
	//naive_output = naive_gaussianfilter(input, 10, 2, 2, "zero-paddle"); //Boundary process: zero-paddle, mirroring, adjustkernel
	//clock_t end = clock();
	//cout << "Time consumption of naive gaussian filter: " << end - start << endl;

	// using gaussian filter implemented in seperable manner
	//start = clock();
	output = gaussianfilter_sep(input, 10, 2, 2, "mirroring"); //Boundary process: zero-paddle, mirroring, adjustkernel
	//end = clock();
	//cout << "Time consumption of seperable gaussian filter: " << end - start << endl;
